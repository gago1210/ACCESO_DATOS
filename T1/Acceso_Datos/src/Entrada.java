...
public static void main(String[] args) {
    //static: es un metodo estatico, que a su vez significa que es un metodo que pertenece a la clase y referirse
    //          al objeto, referencia a la clase en otro lugar que lo queramos utilizar//
    System.out.println("ejemplo de mensaje");
    //aqui vamos a mostrar lo que este en el parentesis//
}
}
